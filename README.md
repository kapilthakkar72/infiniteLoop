...
<i> Eval = (NoOfSteps((P2) - NoOfSteps((P1) ) + 1.1 * (wallsRemaining(P1) - wallsRemaining(P2))</i> <br>
Where, <br>
...
Run the client as “./client <serverIp> <portNo.> 1/0” (1 for AI mode, 0 for human mode) <br>
